export const events = {
  ...
  form: {
    ...
    titleArPlaceholder: "e.g. حفلة MBFshow الموسيقية",
    descriptionLabel: "Description",
    descriptionPlaceholder: "What's this event about?",
    descriptionArLabel: "Description (Arabic)",
    descriptionArPlaceholder: "What's this event about, in Arabic?",
    startsLabel: "Starts",
    ...
    locationArPlaceholder: "e.g. بوليفارد سيتي، الرياض",
    ...
    howToGetThereArLabel: "How to get there (Arabic)",
    howToGetThereArPlaceholder: "Directions, parking, entry gate, etc., in Arabic",
