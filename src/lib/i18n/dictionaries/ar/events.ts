export const events = {
  ...
  form: {
    ...
    titleArPlaceholder: "مثال: حفلة MBFshow الموسيقية",
    descriptionLabel: "الوصف",
    descriptionPlaceholder: "عن ماذا تتحدث هذه الفعالية؟",
    descriptionArLabel: "الوصف (بالعربية)",
    descriptionArPlaceholder: "عن ماذا تتحدث هذه الفعالية، بالعربية؟",
    startsLabel: "تبدأ في",
    ...
    locationArPlaceholder: "مثال: بوليفارد سيتي، الرياض",
    ...
    howToGetThereArLabel: "طريقة الوصول (بالعربية)",
    howToGetThereArPlaceholder: "الاتجاهات، مواقف السيارات، بوابة الدخول، إلخ، بالعربية",
